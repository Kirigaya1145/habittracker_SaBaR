...
class EditHabitFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 1. Hubungkan LifecycleOwner agar Two-Way Binding tahu kapan harus update UI
        ...
        // 2. Amati data dari Room DB (Tameng null-safety tetap dipertahankan)
        ...
        binding.button.setOnClickListener {
            ...
            if (currentHabit != null) {
                // Ambil data dropdown manual karena tidak di-bind di XML
